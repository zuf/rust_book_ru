...
Многозадачность и параллелизм - это невероятно важные проблемамы в области
...
готовы в полной мере использовать их.
...
связи с этим Rust дает нам два типажа, которые помогают нам разбираться в коде,
